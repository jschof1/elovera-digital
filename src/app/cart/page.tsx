    ...
    return (
        ...
        <section className="py-24  dark:bg-gray-700">
            <div className="px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
                <div>
                    <h2 className="mb-8 text-4xl font-bold dark:text-gray-400"><span className='bg-primary p-2'>Your Cart</span></h2>
                    <div className="p-6 mb-8 backdrop-blur-md bg-white/70 rounded-md dark:bg-gray-800 dark:border-gray-800">
                        ...
                        <div className="py-4 mb-8 border-gray-200 dark:border-gray-700">
                                ...
                                <div className="w-full px-4 mb-6 md:w-4/6 lg:w-6/12 md:mb-0">
                                    <div className="flex flex-wrap items-center -mx-4">
                                        ...
                                        <div className="w-2/3 px-4">
                                            <h2 className="mb-2 text-xl font-bold text-primary dark:text-gray-400">
                                                DSL Camera
                                            </h2>
                    ...
                    <div className="flex flex-wrap justify-between">
                        <div className="w-full px-4 mb-4 lg:w-1/2 ">
                            <div className="flex flex-wrap items-center">
                                <span className=" text-xl font-bold text-white mr-4 dark:text-gray-400">
                                    Apply Coupon:
                                </span>
                                <input
                                    type="text"
                                    className="w-full rounded-l-xl px-8 py-4 font-normal placeholder-gray-400 border lg:flex-1 dark:border-gray-700 dark:placeholder-gray-500 dark:text-gray-400 dark:bg-gray-800"
                                    placeholder="x304k45"
                                    required=""
                                />
                                <button className="inline-block rounded-r-xl w-full px-8 py-4 font-bold text-center text-gray-100 bg-primary lg:w-32 hover:bg-black">
                                    Apply
                                </button>
                            </div>
                        </div>
                        <div className="w-full px-4 mb-4 lg:w-1/2 ">
                            <div className="p-6 border border-blue-100 dark:bg-gray-900 dark:border-gray-900 bg-gray-50 md:p-8">
                                ...
                                <div className="flex items-center justify-between ">
                                    <button className="block w-full py-4 font-bold text-center text-gray-100 uppercase bg-primary rounded-md hover:bg-blue-600">
                                        <a target="_blank" href="https://buy.stripe.com/4gw9Dr4dEeg35bObII">   Proceed to checkout</a>
                                    </button>
                                    {/* make the link an ifrmame theat covers most of hte page*/}
